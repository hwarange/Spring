...
/**
 * 게시글 정보를 담는 DTO.
 *  - DB 컬럼 reg_date / view_cnt (snake_case) ↔ 자바 필드 regDate / viewCnt (camelCase)
 *  - 매핑은 application.properties 의
 *    mybatis.configuration.map-underscore-to-camel-case=true 로 처리된다.
 */
public class Board {
	private int id;
